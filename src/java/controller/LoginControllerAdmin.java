 ...
 * @author user
 */
@WebServlet(name = "LoginControllerAdmin", urlPatterns = {"/LoginControllerAdmin"})
       ...
       if(request.getParameter("btn_login")!=null) //check button click event not null from login.jsp page button
        {
            ...
            LoginBeanAdmin loginBean=new LoginBeanAdmin(); //this class contain seeting up all received values from index.jsp page to setter and getter method for application require effectively 
            ...
            LoginDaoAdmin loginDao=new LoginDaoAdmin(); //this class contain main logic to perform function calling and database operation
            ...
            if(authorize.equals("SUCCESS LOGIN")) //check calling authorizeLogin() function receive string "SUCCESS LOGIN" message after continue process
            {
                ...
                RequestDispatcher rd=request.getRequestDispatcher("welcomeAdmin.jsp"); //redirect to welcome.jsp page
                rd.forward(request, response);
            }
            else
            {
                request.setAttribute("WrongLoginMsg",authorize); //wrong login error message is "WrongLoginMsg"
                RequestDispatcher rd=request.getRequestDispatcher("indexAdmin.jsp"); //show error same index.jsp page
