 ...
 * @author pharveish
 */
@WebServlet(name = "resolveMaintenance", urlPatterns = {"/resolveMaintenance"})
public class resolveMaintenance extends HttpServlet {
...
try (PrintWriter out = response.getWriter()) {
           ...
           car.setCarNo(carNo);
            ...
            String returncar=returnCarDao.resolveMaintenance(car); //send registerBean object values into authorizeRegister() function in RegisterDao class
            ...
            else
            {
                ...
                RequestDispatcher rd=request.getRequestDispatcher("welcomeAdmin.jsp"); //show error same page register.jsp page
